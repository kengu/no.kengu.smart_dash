...
mixin _$Device {
  ...
  /// Assumed to not exceed 1 Mb as json-encoded
  /// string (1048576 chars).
...
class _$DeviceImpl extends _Device {
  ...
  @override
  String toString() {
    return 'Device(id: $id, key: $key, name: $name, type: $type, data: $data, capabilities: $capabilities, lastUpdated: $lastUpdated, energy: $energy, voltage: $voltage)';
  }
