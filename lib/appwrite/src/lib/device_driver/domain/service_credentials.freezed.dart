...
abstract class $ServiceCredentialsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String key, String username, String password});
}
...
class _$ServiceImpl implements _Service {
  const _$ServiceImpl(
      {required this.key, required this.username, required this.password});
  ...
  @override
  String toString() {
    return 'ServiceCredentials(key: $key, username: $username, password: $password)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, key, username, password);
