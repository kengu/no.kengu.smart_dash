...
#ifndef SMART_DASH_SWIFT_H
#define SMART_DASH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="smart_dash",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10smart_dash11AppDelegate")
...
SWIFT_CLASS("_TtC10smart_dash17MainFlutterWindow")
...
@interface MainFlutterWindow (SWIFT_EXTENSION(smart_dash)) <FlutterStreamHandler>
