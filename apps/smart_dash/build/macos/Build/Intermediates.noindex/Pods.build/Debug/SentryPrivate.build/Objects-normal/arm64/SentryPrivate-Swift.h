...
#ifndef SENTRYPRIVATE_SWIFT_H
#define SENTRYPRIVATE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SentryPrivate",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13SentryPrivate19HTTPHeaderSanitizer")
...
SWIFT_CLASS("_TtC13SentryPrivate17SentryMXCallStack")
...
SWIFT_CLASS("_TtC13SentryPrivate21SentryMXCallStackTree")
...
SWIFT_CLASS("_TtC13SentryPrivate13SentryMXFrame")
...
SWIFT_CLASS("_TtC13SentryPrivate15SentryMXManager") SWIFT_AVAILABILITY(watchos,unavailable) SWIFT_AVAILABILITY(tvos,unavailable) SWIFT_AVAILABILITY(maccatalyst,introduced=15.0) SWIFT_AVAILABILITY(macos,introduced=12.0) SWIFT_AVAILABILITY(ios,introduced=15.0)
...
SWIFT_PROTOCOL("_TtP13SentryPrivate23SentryMXManagerDelegate_") SWIFT_AVAILABILITY(watchos,unavailable) SWIFT_AVAILABILITY(tvos,unavailable) SWIFT_AVAILABILITY(maccatalyst,introduced=15.0) SWIFT_AVAILABILITY(macos,introduced=12.0) SWIFT_AVAILABILITY(ios,introduced=15.0)
@protocol SentryMXManagerDelegate
...
SWIFT_CLASS("_TtC13SentryPrivate15SwiftDescriptor")
...
SWIFT_CLASS("_TtC13SentryPrivate12UrlSanitized")
