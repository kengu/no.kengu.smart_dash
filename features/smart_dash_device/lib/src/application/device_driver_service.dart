...
part 'device_driver_service.g.dart';

/// A [DriverService] for [Device] lookup from [DeviceDriver]
/// that implements [IntegrationType.device] integrations.
class DeviceDriverService extends DriverService<Device, DriverDataEvent<Device>,
    DeviceDriver, DeviceManager> {
  DeviceDriverService(Ref ref)
      : super(
          ref,
          IntegrationType.device,
          FutureCache(prefix: '$DeviceDriverService'),
        ) {
    ref.onDispose(() {
      _controller.close();
