...
class Identity with _$Identity {
  ...
  factory Identity.from(String key, String id) =>
      Identity(serviceKey: key, deviceId: id);
  ...
  factory Identity.fromToken(Token token) {
    ...
    assert(parts.length == 4, 'Token name [$name] it not valid');
    return Identity(
      deviceId: parts[3],
      serviceKey: parts[1],
    );
