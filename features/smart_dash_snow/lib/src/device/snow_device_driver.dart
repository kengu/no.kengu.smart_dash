...
import 'package:smart_dash_snow/src/device/snow_device_client.dart';

import '../driver/snow_driver_manager.dart';
...
class SnowDeviceDriver extends ThrottledDeviceDriver {
  SnowDeviceDriver({
    ...
    Duration period = SnowDriver.min,
  }) : super(
          trailing: true,
          throttle: period,
        );
  ...
  SnowDeviceClient newClient() {
    return SnowDeviceClient(ref.read(snowDriverManagerProvider).get(config));
  }
}
